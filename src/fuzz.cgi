...
#abcdefg = open('/tmp/canary.txt', 'w')
#abcdefg.write("Hello, World!\n")
#abcdefg.close()
...
if 'length' in cgi.FieldStorage():
	suggLen = int(cgi.FieldStorage()['length'].value)
else:
	suggLen = 1000

if suggLen > 10000: suggLen = 10000
if suggLen < 5: suggLen = 5
