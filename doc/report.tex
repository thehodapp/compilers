...
\begin{document}
	...
	%\subsection{Initial}
	%\input{doc/grammar/initial.tex}
	%\subsection{Null Productions Removed}
	%\input{doc/grammar/nonull.tex}
	%\subsection{Left Recursion Removed}
	%\input{doc/grammar/noleftrec.tex}
	%\subsection{Left Factoring Removed}
	%\input{doc/grammar/final.tex}
